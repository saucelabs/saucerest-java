...
public class StorageEndpoint extends AbstractEndpoint {
  ...
  /**
   * Get files without providing query parameters. Documentation is <a
   * href="https://docs.saucelabs.com/dev/api/storage/#get-app-storage-files">here</a>
   *
  ...
  /**
   * Use parameter names from <a
   * href="https://docs.saucelabs.com/dev/api/storage/#get-app-storage-files">here</a> The
   * parameters can be built manually or by using {@link StorageParameter}
   *
  ...
  public GetAppFiles getFiles(Map<String, Object> params) throws IOException {
    ...
    return deserializeJSONObject(
        requestWithQueryParameters(url, HttpMethod.GET, params), GetAppFiles.class);
  }

  /**
   * Get groups without providing query parameters. Documentation is <a
   * href="https://docs.saucelabs.com/dev/api/storage/#get-app-storage-groups">here</a>
   *
  ...
  /**
   * Use parameter names from <a
   * href="https://docs.saucelabs.com/dev/api/storage/#get-app-storage-groups">here</a> The
   * parameters can be built manually or by using {@link StorageParameter}
   *
   * @param params Query parameters for this request
   * @return {@link GetAppStorageGroups}
  ...
  public GetAppStorageGroups getGroups(Map<String, Object> params) throws IOException {
    ...
    return deserializeJSONObject(
        requestWithQueryParameters(url, HttpMethod.GET, params), GetAppStorageGroups.class);
  }

  /**
   * Get settings of a group. Documentation is <a
  ...
  /**
   * Use parameter names from here <a
   * href="https://docs.saucelabs.com/dev/api/storage/#get-app-storage-group-settings">here</a>
   *
   * @param groupId The ID of the group
  ...
  /**
   * Upload a file to Sauce Labs app storage. Documentation is <a
   * href="https://docs.saucelabs.com/dev/api/storage/#upload-file-to-app-storage">here</a>
   *
   ...
   * @throws IOException API request failed
   */
  public UploadFileApp uploadFile(File file, String fileName, String description)
      throws IOException {
    String url = getBaseEndpoint() + "/upload";

    return deserializeJSONObject(
        postMultipartResponse(url, file, fileName, description), UploadFileApp.class);
  }

  /**
   * Download file from Sauce Labs App Storage. Documentation is <a
   * href="https://docs.saucelabs.com/dev/api/storage/#download-a-file-from-app-storage">here</a>
   *
  ...
  /**
   * Update a files description. Documentation is <a
   * href="https://docs.saucelabs.com/dev/api/storage/#edit-a-stored-files-description">here</a>
   *
   ...
   * @throws IOException API request failed
   */
  public EditFileDescription updateFileDescription(String fileId, String description)
      throws IOException {
  ...
  /**
   * Delete a file from app storage. Documentation is <a
   * href="https://docs.saucelabs.com/dev/api/storage/#delete-an-app-storage-file">here</a>
   *
  ...
  /**
   * Delete a file group. Documentation is <a
   * href="https://docs.saucelabs.com/dev/api/storage/#delete-a-group-of-app-storage-files">here</a>
   *
