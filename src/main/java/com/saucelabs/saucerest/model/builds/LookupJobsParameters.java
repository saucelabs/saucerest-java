...
public class LookupJobsParameters {
    ...
    public static final class Builder {
        ...
        /**
         * Sets the {@code modfied_since} and returns a reference to this Builder enabling method chaining.
         *
         ...
         *
         * @return a {@code LookupJobsParameters} built with parameters of this {@code LookupJobsParameters.Builder}
         */
