...
/** Query parameters for {@code GET /v2/insights/{source}/trends/errors}. */
public class TrendsErrorsParameter {
    ...
    private TrendsErrorsParameter(Builder builder) {
        orgId = builder.orgId;
    ...
    public static final class Builder {
        ...
        public TrendsErrorsParameter build() {
            return new TrendsErrorsParameter(this);
        }
    }
}
