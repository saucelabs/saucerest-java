...
/** Query parameters for {@code GET /v2/insights/{source}/test-cases/stats}. */
public class TestCasesStatsParameter {
    ...
    private TestCasesStatsParameter(Builder builder) {
        orgId = builder.orgId;
    ...
    public static final class Builder {
        ...
        public TestCasesStatsParameter build() {
            return new TestCasesStatsParameter(this);
        }
    }
}
