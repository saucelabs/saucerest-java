...
/** Query parameters for {@code GET /v2/insights/{source}/tests}. */
public class TestsParameter {
    ...
    public Map<String, Object> toMap() {
        ...
        Stream.of(
                        ...
                        new AbstractMap.SimpleEntry<>("error", error),
    ...
    public static final class Builder {
        ...
        public Builder setSortBy(TestsSortBy val) {
            sortBy = val;
            return this;
        }
        ...
        public TestsParameter build() {
            return new TestsParameter(this);
        }
    }
}
