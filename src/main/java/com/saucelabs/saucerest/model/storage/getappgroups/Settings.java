...
public class Settings {
     ...
     * @param lang
     */
    public Settings(Proxy proxy, Boolean audioCapture, Boolean proxyEnabled, String lang, Object orientation, Boolean instrumentationEnabled, Instrumentation instrumentation, Boolean setupDeviceLock) {
        super();
        this.proxy = proxy;
